		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Leave Planner",
									"targetURL": "#comleaveplannerleaveplanner-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comleaveplannerleaveplanner-display": {
								"semanticObject": "comleaveplannerleaveplanner",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.leaveplanner.leaveplanner",
									"url": sap.ui.require.toUrl("com/leaveplanner/leaveplanner")
								}
							}
						}
					}

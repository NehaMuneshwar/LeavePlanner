		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comibsleaveleaveteamplanner-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibsleaveleaveteamplanner-display": {
								"semanticObject": "comibsleaveleaveteamplanner",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibs.leave.leaveteamplanner",
									"url": sap.ui.require.toUrl("com/ibs/leave/leaveteamplanner")
								}
							}
						}
					}
